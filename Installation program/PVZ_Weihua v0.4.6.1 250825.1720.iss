...
#define MyAppVerNum "0.4.6.1"
#define MyAppVerFull "0.4.6.1"
...
; 许可文本:
LicenseFile=E:\Files\PVZ_Weihua\{#MyAppVerNum}\IPT\LF\LF-{#MyAppVerNum}.txt
; 安装前文本:
InfoBeforeFile=E:\Files\PVZ_Weihua\{#MyAppVerNum}\IPT\IBF\IBF-{#MyAppVerNum}.txt
; 安装后文本:
InfoAfterFile=E:\Files\PVZ_Weihua\{#MyAppVerNum}\IPT\IAF\IAF-{#MyAppVerNum}.txt
...
; 打包图标:
SetupIconFile=E:\Files\PVZ_Weihua\{#MyAppVerNum}\Ico\weihua {#MyAppVerNum}.ico
